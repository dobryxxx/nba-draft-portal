...
export const manualFloorScore = p => { const score = manualEvaluation(p)?.floor?.score; return validOutcomeScore(score) ?score : null }
export const manualCeilingScore = p => { const score = manualEvaluation(p)?.ceiling?.score; return validOutcomeScore(score) ?score : null }
